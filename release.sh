...
This is the first release of the Pull Request Analysis GitHub Action. This action uses Anthropic's Claude AI to provide intelligent analysis and review of pull requests.
